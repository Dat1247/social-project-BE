...
const { createComment, getAllComments, getCommentsOfPost, deleteComment, updateComment } = require('../controllers/comment.controllers');
...
commentRouter.put("/update-comment/:id", authenticate, checkExist(Comment, "comment"), checkIsYour, updateComment);
